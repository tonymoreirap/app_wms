...
class Lista_Devolucao extends StatefulWidget {
  @override
  _Lista_DevolucaoState createState() => _Lista_DevolucaoState();
}

class _Lista_DevolucaoState extends State<Lista_Devolucao> {

  List devolucoes = ['Roteador wireless 4 portas 450mbps TL-WR940N Tp Link CX'
